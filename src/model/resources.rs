...
pub async fn load_model(
    ...
    for m in obj_materials? {
        ...
        let normal_texture = load_texture(&normal_texture_file_name, true, device, queue).await?;
...
pub async fn load_texture(
    ...
    model::texture::Texture::from_bytes(device, queue, &data, file_name, is_normal_map)
}